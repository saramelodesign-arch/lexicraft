...
@php
    ...
    $sections = [
        ['semantic-synonyms', __('messages.semantic_synonyms'), $g['synonyms'] ?? collect()],
        ['semantic-broader', __('messages.semantic_broader'), $g['broader'] ?? collect()],
        ['semantic-narrower', __('messages.semantic_narrower'), $g['narrower'] ?? collect()],
        ['semantic-related', __('messages.semantic_related'), $g['related'] ?? collect()],
        ['semantic-industry-variants', __('messages.semantic_industry_variants'), $g['industry_variants'] ?? collect()],
        ['semantic-deprecated', __('messages.semantic_deprecated'), $g['deprecated'] ?? collect()],
    ];
@endphp
