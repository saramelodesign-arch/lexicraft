...
new class extends Component {
    ...
    public function modalConfig(): array
    {
        if ($this->setupComplete) {
            return [
                'title' => __('messages.two_factor_enabled_title'),
                'description' => __('messages.two_factor_enabled_description'),
        ...
        if ($this->showVerificationStep) {
            return [
                'title' => __('messages.two_factor_verify_title'),
                'description' => __('messages.two_factor_code_label'),
                'buttonText' => __('messages.continue'),
            ];
        }

        return [
            'title' => __('messages.two_factor_enable_title'),
            'description' => __('messages.two_factor_enabled_description'),
            'buttonText' => __('messages.continue'),
        ];
    }
